  ...
  "stringMap":[ {
    ...
    "replace" : "next"
            ...
            .bg-gradient-primary-to-secondary {
                background: linear-gradient(90deg, rgba(255, 0, 87, 0.9277736505813148) 0%, rgba(219, 24, 51, 1) 51%, rgba(219, 24, 70, 1) 73%, rgba(219, 24, 70, 1) 100%);
            }
 ...
 */
            ...
            /* Aplica la animación al elemento select */
            .animated-select {
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top shadow-sm" id="mainNav">
            <div class="container px-5">
                <a class="navbar-brand fw-bold" href="#page-top"><img src="assets/img/logo_letras.png" alt="..."
                        style="width: 10rem;" /> </a>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto me-4 my-3 my-lg-0">
                        ...
                        <li class="nav-item" id="nosotros"><a class="nav-link me-lg-3" href="#id_nosotros">Nosotros</a>
                        </li>
                        <li class="nav-item" id="productos"><a class="nav-link me-lg-3"
                                href="#id_coxinhas">Productos</a>
                        </li>
                        <li class="nav-item" id="contacto"><a class="nav-link me-lg-3" href="#id_contacto">Contacto</a>
                        </li>
                        <li class="nav-item" id="redesSociales"><a class="nav-link me-lg-3"
                                href="#id_redesSociales">Redes
                                Sociales</a></li>
                    </ul>
                    ...
                    <select id="selectIdioma" class="animated-select form-select"
            ...
            <div class="container px-5">
                <div class="row gx-5 align-items-center">
                    ...
                    <div class="col-lg-6 text-center">
                        ...
                        <img src="assets/img/regalo_encanto.png" />
            ...
            <div class="container px-5">
                <div class="row gx-5 justify-content-center">
                    <div class="col-xl-8">
                        ...
                        <img src="assets/img/logo_head.png" alt="..." style="height: 5.5rem" />
                    </div>
                </div>
            </div>
        </aside>
                ...
                <div class="row gx-5 align-items-center">
                    ...
                    <div class="col-lg-4 order-lg-0 text-center">
                        ...
                        <video width="420px" controls autoplay>
                            <source src="assets/video_encantos2.mp4" type="video/mp4">
            ...
            <div class="container px-5">
                <div class="row gx-5 align-items-center justify-content-center justify-content-lg-between">
                    ...
                    <div class="col-sm-8 col-md-6">
                        <div class="px-5 px-sm-0"> <img src="assets/img/regalo_flores.png" alt="..."
                                style="width: 100%;" />
                        </div>
                    </div>
                </div>
        ...
        <footer class="bg-black text-center py-5">
            <div class="container px-5">
                <div class="text-white-50 small">
                    ...
                    <a href="https://www.instagram.com/lenncode/" target="_blank">Creado por : Lenncode</a>
